...
if(isset($_POST['reset_password']) && $_SERVER['REQUEST_METHOD']==='POST'){
 ...
 $getMail=$conn->prepare("SELECT admin_name,admin_password,admin_email FROM tbl_admin WHERE admin_email='$mail'");
 $getMail->execute();
 $admin_data=$getMail->fetchAll(PDO::FETCH_ASSOC);

 if(count($admin_data)>0){
    $name=$admin_data[0]['admin_name'];
    $password=$admin_data[0]['admin_password'];
    $mail1=$admin_data[0]['admin_email'];
    ...
    $email_message = "<h3>Password For Your Admin Account</h3>\n\n";
                                ...
                                <div class="p-2">
                                    ...
                                    <form class="form-horizontal" action="#" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="useremail" name="admin_mail" placeholder="Enter Your Email">
                                        </div>
